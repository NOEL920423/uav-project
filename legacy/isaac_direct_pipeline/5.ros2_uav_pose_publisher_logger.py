...
class ROS2UAVPosePublisherLogger:
    ...
    def setup_csv(self):
        ...
        self.csv_path = os.path.join(LOG_DIR, f"{CSV_PREFIX}_{stamp}.csv")
...
def start_ros2_uav_pose_publisher_logger():
    stop_existing_ros2_uav_pose_publisher_logger()

    recorder = ROS2UAVPosePublisherLogger()
...
# Start immediately when this script is run.
